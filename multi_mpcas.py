...
def do_job(tasks_to_accomplish, tasks_that_are_done):
    while True:
        try:
            ...
            tasks_that_are_done.put({'name': task['name'], 'point': task['point'].copy(), 'n': task['n'], 'alpha': task['alpha'].copy(), 'result': [task['result'][i].copy() for i in range(len(task['result']))], 'time': task['time']})
